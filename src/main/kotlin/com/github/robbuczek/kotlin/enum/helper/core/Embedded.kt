...
import com.github.robbuczek.kotlin.enum.helper.utils.EnumClass
...
open class Embedded {
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> get(enums: EnumClass, key: KEY): ENUM_TYPE? where KEY: Any, ENUM_TYPE: EnumHelper<KEY>
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> get(enums: EnumClass, keys: Collection<KEY>): List<ENUM_TYPE> where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
    ...
    inline fun <reified ENUM_TYPE, KEY> single(enums: EnumClass, key: KEY): ENUM_TYPE where KEY: Any, ENUM_TYPE: EnumHelper<KEY>
    ...
    inline fun <reified ENUM_TYPE, KEY> first(enums: EnumClass, keys: Collection<KEY>): ENUM_TYPE where KEY: Any, ENUM_TYPE: EnumHelper<KEY> {
        for (key in keys) {
     ...
     */
    @Throws(NoSuchElementException::class)
    inline fun <reified ENUM_TYPE, KEY> last(enums: EnumClass, keys: Collection<KEY>): ENUM_TYPE where KEY: Any, ENUM_TYPE: EnumHelper<KEY> {
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> getOrDefault(enums: EnumClass, key: KEY, default: ENUM_TYPE): ENUM_TYPE where KEY: Any, ENUM_TYPE: EnumHelper<KEY>
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> getOrDefault(enums: EnumClass, keys: Collection<KEY>, default: List<ENUM_TYPE>): List<ENUM_TYPE> where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> getOrDefault(enums: EnumClass, keys: Collection<KEY>, default: ENUM_TYPE): List<ENUM_TYPE> where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
     ...
     */
    inline fun <reified ENUM_TYPE, KEY> anyOrDefault(enums: EnumClass, keys: Collection<KEY>, default: ENUM_TYPE): ENUM_TYPE where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
     ...
     * @param keys requested elements
     */
    inline fun <reified ENUM_TYPE, KEY> allExists(enums: EnumClass, keys: Collection<KEY>): Boolean where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
     ...
     * @param keys requested elements
     */
    inline fun <reified ENUM_TYPE, KEY> anyExists(enums: EnumClass, keys: Collection<KEY>): Boolean where KEY: Any, ENUM_TYPE: EnumHelper<KEY> =
